export const sideElements = [
    ...
    },
    {
        svg: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#ffffff"} fill={"none"}>
                <path d="M14.9263 2.91103L8.27352 6.10452C7.76151 6.35029 7.21443 6.41187 6.65675 6.28693C6.29177 6.20517 6.10926 6.16429 5.9623 6.14751C4.13743 5.93912 3 7.38342 3 9.04427V9.95573C3 11.6166 4.13743 13.0609 5.9623 12.8525C6.10926 12.8357 6.29177 12.7948 6.65675 12.7131C7.21443 12.5881 7.76151 12.6497 8.27352 12.8955L14.9263 16.089C16.2637 16.7068 18 15.7587 18 14.2443V5.75573C18 4.24128 16.2637 3.29318 14.9263 2.91103Z" stroke="currentColor" strokeWidth="1.5" />
                <path d="M7 8.5L5 8.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
