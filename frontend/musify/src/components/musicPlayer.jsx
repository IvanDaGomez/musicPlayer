...
export function MusicPlayer(){
    ...
    const [actualSongState, setActualSongState] = useState("paused")
    ...
    const [lastVolumeValue, setLastVolumeValue] = useState(50);
    ...
    return (
        <>
        <audio ref={audio}>
            <source src="/I'm A Human - Dr.Stone.mp3"/>
        </audio>
        <div className="musicPlayer">
            <div className="left">
                <img src="" alt="God Cancionns" />
                <div className="title">
                    <h3>God Cancion</h3>
                    <p>God autor</p>
                </div>
            ...
            <div className="middle">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={30} height={30} color={"#ffffff"} fill={"#ffffff"}>
    ...
    <path d="M12.1629 12.9178C12.4453 13.6884 13.2986 14.3047 15.0052 15.5372C17.3323 17.218 18.4959 18.0583 19.4688 17.9969C20.2118 17.9499 20.9024 17.6007 21.3777 17.0315C22 16.2863 22 14.8575 22 12C22 9.14246 22 7.71369 21.3777 6.96846C20.9024 6.39933 20.2118 6.0501 19.4688 6.00315C18.4959 5.94167 17.3323 6.78203 15.0052 8.46275C13.2986 9.6953 12.4453 10.3116 12.1629 11.0822C11.9457 11.675 11.9457 12.325 12.1629 12.9178Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
                ...
                {(actualSongState === "paused" ) ? <svg onClick={()=>changePlayState(actualSongState)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={40} height={40} color={"#000000"} fill={"#000000"} className="playstate">
